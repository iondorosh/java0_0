...
public class Variant1Test {
    ...
    public Object[][] switchProvider() {
        return new Object[][] { { 3, DAY_OF_WEEK.WEDNESDAY }, { 6, DAY_OF_WEEK.SATURDAY } };
    }

    @Test(expectedExceptions = AssertionError.class)
    public void switchNegativeTest() {
        new Variant1().forTask(-2);
    }
    ...
    public Object[][] arrayProvider() {
        return new Object[][] { { new double[] { 10, 2, 3 }, 0 }, { new double[] { 10, 2, 13 }, 0 }, { new double[] { 4, 3, 5, -4, 9, 2 }, 0 } };
    }
